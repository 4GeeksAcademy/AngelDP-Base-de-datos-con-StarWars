...
from models import db, User, Person, Starship, Vehicle, Specie, Planet, Favorite
...
#---------------------------------------------------------------ENPOINTS to GET and POST users---------------------------------------------------------------#
...
def get_all_people():
    ...
    response_body = {
        "people": [people.serialize() for people in people]
    }
    return jsonify({
        response_body
    }), 200
