from app import app
from models import db, People, Starship, Vehicle, Specie, Planet
...
with app.app_context():
    ...
    Planet(population=1000000000000, climate="temperate",
    ...
    people = [
    People(name="Luke Skywalker", height=1.72, hair_color="Blond", 
           skin_color="Fair", eye_color="Blue", gender="Male"),
    People(name="Darth Vader", height=2.03, hair_color="None", 
           skin_color="Pale", eye_color="Yellow", gender="Male"),
    People(name="Leia Organa", height=1.50, hair_color="Brown", 
           skin_color="Fair", eye_color="Brown", gender="Female"),
    People(name="Yoda", height=0.66, hair_color="White", 
           skin_color="Green", eye_color="Brown", gender="Male"),
    People(name="Chewbacca", height=2.28, hair_color="Brown", 
